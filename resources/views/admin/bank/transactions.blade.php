...
@section('bread1', 'Transactions')
@section('bread2', 'All Transactions')
...
<div class="card card-custom card-stretch gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="{{url('admin/bank/withdrawalrequest')}}" class="btn btn-success font-weight-bolder font-size-sm"><i class="fas fa-money-alt"></i> </span>Withdrawal Request
            </a>
        </div>
    </div>
    <!--end::Header-->
