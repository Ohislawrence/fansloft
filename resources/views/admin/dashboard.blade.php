...
<!--begin::Toolbar-->
 <a data-toggle="modal" data-target="#platform" class="btn btn-transparent-white font-weight-bold  py-3 px-6 mr-2">
    <i class="la la-plus"></i>Add Platform</a>
...
<div class="card card-custom bgi-no-repeat card-stretch gutter-b"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$allusers->count()}}</span>
        
        <span class="font-weight-bold text-muted  font-size-sm"><a href="{{url('admin/userlist')}}">All Users</a></span>
    </div>
    <!--end::Body-->
...
<div class="card card-custom bg-info card-stretch gutter-b">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ $allusers->where('role', 'brand')->count() }}</span>
        
        <span class="font-weight-bold text-white  font-size-sm">Brands</span>
    </div>
    <!--end::Body-->
</div>
<!--end::Stats Widget 30-->
...
<div class="card card-custom bg-danger card-stretch gutter-b">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$allusers->where('role', 'creator')->count()}}</span>
        
        <span class="font-weight-bold text-white  font-size-sm">Creators</span>
    </div>
    <!--end::Body-->
</div>
<!--end::Stats Widget 31-->
...
<div class="card card-custom bg-dark card-stretch gutter-b">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">₦ {{$profits->sum('commission')}}</span>
