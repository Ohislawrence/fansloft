...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8"/>
        <title>User Not Found | Fansloft</title>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700"/>        <!--end::Fonts-->
                    ...
                    <!--begin::Page Custom Styles(used by this page)-->
                             <link href="{{url('public/assets/css/pages/error/error-3.css?v=7.0.6')}}" rel="stylesheet" type="text/css"/>
                        <!--end::Page Custom Styles-->

        <!--begin::Global Theme Styles(used by all pages)-->
                    <link href="public/assets/plugins/global/plugins.bundle.css?v=7.0.6" rel="stylesheet" type="text/css"/>
	...
	<div class="d-flex flex-column flex-root">
		<!--begin::Error-->
<div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{url('public/assets/media/error/bg3.jpg')}});">
	<!--begin::Content-->
	<div class="px-10 px-md-30 py-10 py-md-0 d-flex flex-column justify-content-md-center">
		<h1 class="error-title text-stroke text-transparent">Ooops....</h1>
		<p class="display-4 font-weight-boldest text-white mb-12">
			How did you get here
		</p>
		<p class="font-size-h1 font-weight-boldest text-dark-75">
			Sorry we can't seem to find the account you're looking for.
		</p>
		...
		<p>
			<a href="{{url('/')}}" class="btn btn-primary font-weight-bold  py-3 px-6 mr-2" data-placement="top"></i>Go to Home Page</a>
		</p>
	</div>
	<!--end::Content-->
</div>
