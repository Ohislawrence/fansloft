...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">My Influencers</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">These is a list of all your influencers</span>
        </h3>
...
</svg><!--end::Svg Icon--></span>Add a New Influencer</a>
        </div>
    </div>
    <!--end::Header-->
