...
@section('bread2', 'Create New Campaign')
...
<div class="alert alert-danger" role="alert">
    You can not create a campaign because your plan has expired. <a href= "{{url('brand/profile/plan')}}">Click here to renew now</a>.
</div>
@endif
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M9.70710318,15.7071045 C9.31657888,16.0976288 8.68341391,16.0976288 8.29288961,15.7071045 C7.90236532,15.3165802 7.90236532,14.6834152 8.29288961,14.2928909 L14.2928896,8.29289093 C14.6714686,7.914312 15.281055,7.90106637 15.675721,8.26284357 L21.675721,13.7628436 C22.08284,14.136036 22.1103429,14.7686034 21.7371505,15.1757223 C21.3639581,15.5828413 20.7313908,15.6103443 20.3242718,15.2371519 L15.0300721,10.3841355 L9.70710318,15.7071045 Z" fill="#000000" fill-rule="nonzero" transform="translate(14.999999, 11.999997) scale(1, -1) rotate(90.000000) translate(-14.999999, -11.999997) "/>
            ...
            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                <div class="col-xl-12 col-xxl-7">
                    <!--begin::Wizard Form-->
                    <form class="form " id="kt_form" action="{{ url('brand/campaign/twitter/post')}}" method="post" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg" name="campaign_name" id="campaign_name" value="" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg" name="url" id="url" value="" placeholder="https://yourwebsite.com/something/somethingesle" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" rows="3" class="form-control form-control-solid form-control-lg" name="desc" id="desc" placeholder="" /></textarea> 
                                <span class="form-text text-muted">Describe your campaign</span>
                            </div>
                            <!--end::Input-->
                            <div class="row">
                                <div class="col-xl-6">
          ...
          @endforeach
                                ...
                                <div class="col-xl-6">
                                    <!--begin::Input-->
                                    <div class="form-group">
                                        <label>Set campaign privacy</label>
                                        <br><input name="privacy" data-switch="true" type="checkbox" checked="checked" data-on-text="On" data-handle-width="70" data-off-text="Off" data-on-color="primary"/>

                                        <span class="form-text text-muted">On: only people you invite will see this. Off
                                        : all creators can view this.</span>
                                    </div>
                                    <!--end::Input-->
                                </div>
                            </div>
                ...
                <select name="interest[]" id="kt_select2_10" multiple="multiple" class="form-control form-control-solid form-control-sm"/>
        ...
        @endforeach
                   ...
                   <span class="form-text text-muted">what interest groups would you like to reach?</span>
                                    ...
                                    <!--begin::Input-->
                            <div class="form-group">
                <label>Campaign Digital Asset</label>
                <div class="col-lg-12 col-md-9 col-sm-12 file-upload-wrapper">
                    
                    <input type="file" name="image[]" id="input-file-now" class="form-control" multiple/>
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg" name="cta" placeholder="" value="" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" rows="4" class="form-control form-control-solid form-control-lg" name="details" value="25" /></textarea>
                            ...
                            <input id="kt_tagify_3" class="form-control form-control-solid form-control-lg" name='tags' class='form-control tagify tagify--outside' placeholder='' value=''/>
                            <span class="form-text text-muted">e.g #fansloft, seperate with comma</span>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="quotes" placeholder="@fansloft, @youtube, @apple" value="" />
                                        <span class="form-text text-muted">e.g @fansloft, seperate with comma</span>
                                    </div>
                                    <!--end::Input-->
                                </div>
            ...
            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg" name="duration" id="kt_daterangepicker_1" readonly placeholder="Select time" />
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                                ...
                                <input type="text" rows="4" class="form-control form-control-solid form-control-lg" name="freq" value="" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg" name="budget"  placeholder="Budget" />
                            
                                <span class="form-text text-muted">What is your total budget for this campaign in NGN(₦)?.</span>
                            </div>
                        </div>
                    </div>
                        <!--end::Wizard Step 3-->
...
<script src="{{url('public/assets/js/pages/crud/file-upload/dropzonejs.js?v=7.0.6')}}"></script>

<script src="{{url('public/assets/js/pages/crud/forms/widgets/bootstrap-switch.js?v=7.0.6')}}"></script>
@endsection
